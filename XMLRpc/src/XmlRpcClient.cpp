...
XmlRpcClient::execute(const char* method, XmlRpcValue const& params, XmlRpcValue& result)
{
  ...
  /*每次均需要添加资源 Added by Chaolong 2012-1116*/
  InitSrc(); 
  ...
  /*释放资源 Added by Chaolong 2012-1116*/
  close();
...
XmlRpcClient::readHeader()
{
  ...
  XmlRpcUtil::log(5, "XmlRpcClient::ReadResult\n%s\n", _header.c_str());
